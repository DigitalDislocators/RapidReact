...
public class AutoDriveToPointCmd extends CommandBase {
    ...
    /**
     * Constructs a new AutoStraightHeadingCmd with a target heading.
     * 
    ...
    public void execute() {
        ...
        double turnPower = (heading * Constants.autoStraightTurnKp) + m_turnPush;
        ...
        double drivePower = (distance * Constants.autoDriveToPointKp) + m_drivePush;
