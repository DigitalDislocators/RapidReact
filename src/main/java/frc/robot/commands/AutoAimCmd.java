...
public class AutoAimCmd extends CommandBase {
    ...
    private final LimelightSys m_limelightSys;
    ...
    public AutoAimCmd(double power, PropulsionSys subsystem1, LimelightSys subsystem2) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        m_propulsionSys = subsystem1;
        m_limelightSys = subsystem2;
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber("xval", m_limelightSys.getX());
        SmartDashboard.putBoolean("isFinished", m_isFinished);
        ...
        if(Math.abs(m_propulsionSys.getAngleRate()) < 10) {
            if(m_limelightSys.getX() > m_angle - 0.5 && m_limelightSys.getX() < m_angle + 0.5) {
                m_push = 0;
                m_isFinished = true;
            }
            else {
                if(power < 0) {
                    m_push -= Constants.Kp.aim * 0.5;
                }
                else {
                    m_push += Constants.Kp.aim * 0.5;
                }
        ...
        m_propulsionSys.setAimPower(power);
    }
    ...
    public void end(boolean interrupted) {
        ...
        m_propulsionSys.setAimPower(0.0);
    }
