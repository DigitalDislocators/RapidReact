...
public class ClimberDownCmd extends CommandBase {
    ...
    public ClimberDownCmd(ClimberSys subsystem) {
    ...
    public void execute() {
        ...
        SmartDashboard.putString("Status", "CLIMBING: " + (Constants.Encoder.climberDown - m_climberSys.getClimberCounts()));
    }
    ...
    public void end(boolean interrupted) {
        ...
        SmartDashboard.putString("Status", "CLIMBED");
    }
    ...
    public boolean isFinished() {
        return m_climberSys.getClimberCounts() > Constants.Encoder.climberDown || m_climberSys.getClimberCounts() < Constants.Encoder.climberUp;
    }
