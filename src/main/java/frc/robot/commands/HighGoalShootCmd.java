...
public class HighGoalShootCmd extends CommandBase {
    ...
    public HighGoalShootCmd(ShooterSys subsystem1, TurretSys subsystem2) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        m_turretSys = subsystem2;
        addRequirements(m_shooterSys, m_turretSys);
