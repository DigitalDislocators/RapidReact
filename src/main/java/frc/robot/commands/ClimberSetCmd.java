...
public class ClimberSetCmd extends CommandBase {
    ...
    public ClimberSetCmd(ClimberSys subsystem) {
    ...
    public void initialize() {
        SmartDashboard.putString("Status", "CLIMBER SETTING");
        m_timer.start();
    }
    ...
    public void end(boolean interrupted) {
        ...
        SmartDashboard.putString("Status", "CLIMBER SET");
    }
