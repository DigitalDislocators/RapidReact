...
public class AutoTwoBallShortPrgm extends SequentialCommandGroup {

    public AutoTwoBallShortPrgm(PropulsionSys propulsionsys, IndexerSys indexerSys, ShooterSys shooterSys, TurretSys turretSys) {
        super(
            new TrackingOffCmd(turretSys),
            new LaunchpadShootCmd(shooterSys),
            new StartIntakeCmd(indexerSys),
            new AutoStraightHeadingCmd(3, 6, 0, 0.3, propulsionsys),
