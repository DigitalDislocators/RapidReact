 ...
 *
 */
public class AutoTurnHeadingCmd extends CommandBase {
    ...
    /**
     * Constructs a new AutoTurnHeadingCmd.
     * 
     ...
     * 
     */
    public AutoTurnHeadingCmd(double heading, double power, PropulsionSys subsystem) {
    ...
    public void initialize() {
        SmartDashboard.putNumber("target", m_heading);
    ...
    public void execute() {
        ...
        double power = ((m_heading - m_propulsionSys.getHeading()) * Constants.autoTurnKp) + m_push;
        ...
        if(Math.abs(m_propulsionSys.getAngleRate()) < 20) {
            if(m_propulsionSys.getHeading() > m_heading - 0.5 && m_propulsionSys.getHeading() < m_heading + 0.5) {
                ...
                if(power < 0) {
                    m_push -= Constants.autoTurnKp * 0.5;
                }
                else {
                    m_push += Constants.autoTurnKp * 0.5;
                }
        ...
        SmartDashboard.putNumber("push", m_push);
