 ...
 *
 */
public class AutoTurnCmd extends CommandBase {
     ...
     * 
     */
    public AutoTurnCmd(double degrees, double power, PropulsionSys subsystem) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        m_heading = m_propulsionSys.getHeading() + degrees;
