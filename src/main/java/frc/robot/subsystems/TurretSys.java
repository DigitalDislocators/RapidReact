...
public class TurretSys extends SubsystemBase {
     ...
     */
    public TurretSys(IndexerSys indexerSys) {
    ...
    public void periodic() {
        ...
        if(!m_trackingEnabled || !m_indexerSys.cargoIsIn() || DriverStation.isDisabled()) {
            setLED(false);
            m_isTracking = false;
            setAngle(0, false);
        }
    ...
    public void track() {
        if(m_trackingEnabled && m_isTracking && m_indexerSys.cargoIsIn() && !m_isInverting) {
