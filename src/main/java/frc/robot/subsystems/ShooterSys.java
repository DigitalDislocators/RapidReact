...
public class ShooterSys extends SubsystemBase {
    ...
    public ShooterSys() {
        ...
        sb_shooterPercent = Shuffleboard.getTab("DOOFENSHMIRTZ").add("Shooter Percent", 0).getEntry();
        sb_shooterTarget = Shuffleboard.getTab("DOOFENSHMIRTZ").add("Shooter Target", 0).getEntry();
        sb_shooterError = Shuffleboard.getTab("DOOFENSHMIRTZ").add("Shooter Error", 0).getEntry();
    }
