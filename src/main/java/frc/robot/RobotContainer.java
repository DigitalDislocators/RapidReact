...
// The robot's subsystems
    ...
    public final IndexerSys m_intakeSys = new IndexerSys();
  ...
  private RobotContainer() {
    ...
    // Configure default commands
        ...
        m_propulsionSys.setDefaultCommand(new RunCommand(
          () -> m_propulsionSys.arcadeDriveControl(-leftJoystick.getY(), leftJoystick.getX(), rightJoystick.getX() + (rightJoystick.getZ() * 0.5)), m_propulsionSys)
        );
