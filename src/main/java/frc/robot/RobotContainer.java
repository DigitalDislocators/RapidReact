...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    Shuffleboard.getTab("DOOFENSHMIRTZ").add(m_chooser);
  }
  ...
  private void operatorBindingsBodi() {
    ...
    m_operatorYButton.whileHeld(new YEETRoutineCmd(m_shooterSys, m_indexerSys)).whenReleased(new StopShooterCmd(m_shooterSys)).whenReleased(new StopIndexerCmd(m_indexerSys));
    ...
    m_turretSys.setDefaultCommand(new RunCommand(
      () -> m_turretSys.joystickPOVControl(m_operatorController.getRawAxis(4), -m_operatorController.getRawAxis(5)),
      m_turretSys));
