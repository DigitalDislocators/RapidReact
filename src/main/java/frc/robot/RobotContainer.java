...
public class RobotContainer {
  ...
  */
  ...
  private void driverBindingsLogan() {
    ...
    m_driverRight3
    // .whileHeld(new LaunchpadShootRoutineCmd(m_shooterSys, m_indexerSys))
    .whileHeld(new AutoLaunchpadShootSeq(m_indexerSys, m_shooterSys)).whenReleased(new StopShooterCmd(m_shooterSys)).whenReleased(new StopIndexerCmd(m_indexerSys));
  ...
  private void operatorBindingsBodi() {
    ...
    m_operatorXButton.whileHeld(new PrepareFeedCmd(m_indexerSys)).whenReleased(new StopIndexerCmd(m_indexerSys));
