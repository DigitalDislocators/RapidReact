...
private final JoystickButton m_right5 = new JoystickButton(m_rightJoystick, 5);
  ...
  */
  private RobotContainer() {
    ...
    m_rightTrigger.whileHeld(new StartIndexerCmd(m_indexerSys)).whenReleased(new StopIndexerCmd(m_indexerSys));
    ...
    // Configure default commands
        ...
        m_propulsionSys.setDefaultCommand(new RunCommand(
          () -> m_propulsionSys.mecanumDriveNonlinear(m_leftJoystick.getX(), -m_leftJoystick.getY(), m_rightJoystick.getX() + (m_rightJoystick.getZ() * Constants.fineTurnRatio), false),
          m_propulsionSys)
        );
...
public Joystick getRightJoystick() {
  ...
  */
  public Command getAutonomousCommand() {
    ...
    return new AutoStraightCmd(10, 0, 0.5, m_propulsionSys);
  }
